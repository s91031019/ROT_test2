...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="/home/rvl224/文件/output/07071", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default="YOLOX_outputs/yolox_voc_s/last_epoch_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="cpu",
        type=str,
